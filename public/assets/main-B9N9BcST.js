import{i as e,n as t,r as n,t as r}from"./jsx-runtime-DV0NqZJm.js";var i=e(n(),1),a=t(),o=r();function s(e){let t=(0,i.useRef)(null),n=(0,i.useRef)(null),[r,a]=(0,i.useState)(800),s=(0,i.useCallback)(()=>{let e=t.current?.contentDocument;if(!e)return;let n=e.querySelector(`.page`),r=Math.ceil(Math.max(n?.getBoundingClientRect().height??0,n?.scrollHeight??0)),i=Math.max(r,800);Number.isFinite(i)&&i>0&&a(i)},[]),d=(0,i.useCallback)(()=>{let e=t.current,r=e?.contentDocument;if(r){if(s(),n.current?.disconnect(),`ResizeObserver`in window&&r.body){let e=new ResizeObserver(()=>s());e.observe(r.body);let t=r.querySelector(`.page`);t&&e.observe(t),n.current=e}e.contentWindow?.addEventListener(`resize`,s),window.setTimeout(s,100),window.setTimeout(s,500),window.setTimeout(s,1200)}},[s]);return(0,i.useEffect)(()=>(window.addEventListener(`resize`,s),()=>{window.removeEventListener(`resize`,s),n.current?.disconnect(),t.current?.contentWindow?.removeEventListener(`resize`,s)}),[s]),(0,i.useEffect)(()=>{let e=0,n=()=>{e=0;let n=t.current;if(!n?.contentWindow)return;let r=n.getBoundingClientRect();n.contentWindow.postMessage({type:`portfolio-viewport`,viewportTop:-r.top,viewportHeight:window.innerHeight},`*`)},r=()=>{e||=window.requestAnimationFrame(n)};window.addEventListener(`scroll`,r,{passive:!0}),window.addEventListener(`resize`,r);let i=[100,500,1200].map(e=>window.setTimeout(r,e));return r(),()=>{window.removeEventListener(`scroll`,r),window.removeEventListener(`resize`,r),e&&window.cancelAnimationFrame(e),i.forEach(e=>window.clearTimeout(e))}},[]),(0,o.jsx)(`div`,{style:{...e.style,display:`block`,width:`100%`,minWidth:0,maxWidth:`100%`,height:r,overflow:`hidden`,background:`#F3F0E8`},children:(0,o.jsx)(`iframe`,{ref:t,title:`Simran Narwani Portfolio`,srcDoc:u.replaceAll(`<div class="work-panel-actions"><a class="work-case-link" href="javascript:void(0)">Open the case study <span aria-hidden="true">↗</span></a></div>`,``).replace(`</head>`,`<style>${c}</style></head>`).replace(`</body>`,`<script>${l}<\/script></body>`),onLoad:d,scrolling:`no`,style:{display:`block`,width:`100%`,height:r,border:0,margin:0,padding:0,overflow:`hidden`,background:`#F3F0E8`}})})}var c=`
  :root {
    --bg: #F3F0E8;
    --paper: #FFFDF7;
    --ink: #101B33;
...
`;(0,a.createRoot)(document.getElementById(`root`)).render((0,o.jsx)(i.StrictMode,{children:(0,o.jsx)(s,{})}));
